...
public abstract class Generator : MonoBehaviour {
	...
	public Tile[,] GenerateTileMap(tileMapManager manager,int width, int height, float lacunarity,int seed)
	{
		Height = height;
		Width = width;
		Seed = seed;
		Instantiate (lacunarity);
		Generate ();
		manager.ColdValue = ColdValue;
		manager.ColderValue = ColderValue;
		manager.ColdestValue = ColdestValue;
		return Tiles;
	}
	
	public void Maps(int Width,int Height,Tile[,] Tiles,float ColdestValue,float ColderValue,float ColdValue)
	{
    ...
    protected abstract void Initialize(float lacunarity);
    ...
    protected virtual void Instantiate (float lacunarity) {
